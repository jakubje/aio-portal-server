...
type Roll_Up struct {
	...
	TotalCoins   float32 `protobuf:"fixed32,4,opt,name=total_coins,json=totalCoins,proto3" json:"total_coins,omitempty"`
	PricePerCoin float32 `protobuf:"fixed32,5,opt,name=price_per_coin,json=pricePerCoin,proto3" json:"price_per_coin,omitempty"`
}
...
func (x *Roll_Up) GetTotalCost() float32 {
	if x != nil {
		return x.TotalCost
	}
	return 0
...
func (x *Roll_Up) GetTotalCoins() float32 {
	if x != nil {
		return x.TotalCoins
	}
	return 0
...
func (x *Roll_Up) GetPricePerCoin() float32 {
	if x != nil {
...
var file_roll_up_proto_rawDesc = []byte{
	...
	0x6f, 0x74, 0x61, 0x6c, 0x5f, 0x63, 0x6f, 0x73, 0x74, 0x18, 0x03, 0x20, 0x01, 0x28, 0x02, 0x52,
	0x09, 0x74, 0x6f, 0x74, 0x61, 0x6c, 0x43, 0x6f, 0x73, 0x74, 0x12, 0x1f, 0x0a, 0x0b, 0x74, 0x6f,
	0x74, 0x61, 0x6c, 0x5f, 0x63, 0x6f, 0x69, 0x6e, 0x73, 0x18, 0x04, 0x20, 0x01, 0x28, 0x02, 0x52,
	...
	0x01, 0x28, 0x02, 0x52, 0x0c, 0x70, 0x72, 0x69, 0x63, 0x65, 0x50, 0x65, 0x72, 0x43, 0x6f, 0x69,
