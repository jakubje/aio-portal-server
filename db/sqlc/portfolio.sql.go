...
func (q *Queries) CreatePortfolio(ctx context.Context, arg CreatePortfolioParams) (Portfolio, error) {
	row := q.db.QueryRow(ctx, createPortfolio, arg.Name, arg.AccountID)
	var i Portfolio
	err := row.Scan(
		&i.ID,
		&i.AccountID,
...
func (q *Queries) DeletePortfolio(ctx context.Context, arg DeletePortfolioParams) error {
	_, err := q.db.Exec(ctx, deletePortfolio, arg.ID, arg.AccountID)
	return err
}
...
func (q *Queries) GetPortfolio(ctx context.Context, arg GetPortfolioParams) (Portfolio, error) {
	row := q.db.QueryRow(ctx, getPortfolio, arg.ID, arg.AccountID)
	var i Portfolio
	err := row.Scan(
		&i.ID,
		&i.AccountID,
...
func (q *Queries) ListPortforlios(ctx context.Context, accountID int64) ([]Portfolio, error) {
	rows, err := q.db.Query(ctx, listPortforlios, accountID)
	if err != nil {
		return nil, err
	}
	defer rows.Close()
...
func (q *Queries) UpdatePortfolio(ctx context.Context, arg UpdatePortfolioParams) (Portfolio, error) {
	row := q.db.QueryRow(ctx, updatePortfolio, arg.ID, arg.Name, arg.AccountID)
	var i Portfolio
	err := row.Scan(
		&i.ID,
		&i.AccountID,
